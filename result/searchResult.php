...
<p><input type="text" name="coursename" value="" placeholder="Enter Course Name" id="coursename"></p>
<p><input type="text" name="courseid" value="" placeholder="Enter Course ID" id="courseid"></p>
<p><input type="radio" name="semester" value="Fall" /><br/>
<input type="radio" name="semester" value="Spring" /><br/>
